...
public class SkeletonValidator {
	...
	public SkeletonValidator(){
		...
		validateClassName("com.SpringCore.AspectOP.SpringAop.AopConfig");
		
		validateClassName("com.SpringCore.AspectOP.SpringAop.EasyBank");
		validateMethodSignature("doWithdraw:void,showBalance:void,doDeposit:void,doChangePin:void","com.SpringCore.AspectOP.SpringAop.EasyBank");

		validateClassName("com.SpringCore.AspectOP.SpringAop.LoginAspect");
		validateMethodSignature("validateWithdraw:void,validateBalance:void,afterPinChange:void,afterWrongPin:void","com.SpringCore.AspectOP.SpringAop.LoginAspect");
